...
/// MoonPay Sell (Offramp) WebView Widget
/// 
/// Displays the MoonPay sell checkout page in an in-app webview/iframe
...
class MoonPaySellWebView extends StatefulWidget {
  ...
  @override
  State<MoonPaySellWebView> createState() => _MoonPaySellWebViewState();
}

class _MoonPaySellWebViewState extends State<MoonPaySellWebView> {
  ...
  void initState() {
    ...
    _viewType = 'moonpay-sell-iframe-${_viewIdCounter++}';
  ...
  Future<void> _handleCallbackUrl(String url) async {
    if (url.contains("moonpay.com/success") || 
      ...
      debugPrint('✅ Sell transaction completed detected!');
      _handlePaymentCompleted();
    } else if (url.contains("moonpay.com/error") || 
               url.contains("cancelled")) {
      debugPrint('❌ Sell transaction cancelled/failed detected');
  ...
  void _handlePaymentCompleted() {
    debugPrint('✅ Sell transaction completed!');
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Your fiat payment will be processed and sent to your account.',
              style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '${widget.amountCrypto.toStringAsFixed(4)} ${widget.currencyCode.toUpperCase()}',
                    style: TextStyle(
                      color: AppTheme.white,
                      fontSize: 13,
            ...
            Text(
              'Transaction processed via Polygon network',
              style: TextStyle(
  ...
  /// Handle cancelled/failed sell transaction
  void _handlePaymentCancelled() {
    debugPrint('❌ Sell transaction cancelled');
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Your sell transaction was cancelled. No tokens were sold.',
              style: TextStyle(
                color: AppTheme.white,
                fontSize: 14,
              ),
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              '${widget.amountCrypto.toStringAsFixed(4)} ${widget.currencyCode.toUpperCase()} → Fiat',
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Fiat payment will be sent to your account.',
                  style: AppTheme.bodySmall.copyWith(
...
/// Shows MoonPay sell in a fullscreen dialog/page
Future<Map<String, dynamic>?> showMoonPaySellWebView({
  ...
  return await Navigator.of(context).push<Map<String, dynamic>>(
    MaterialPageRoute(
      ...
      builder: (context) => MoonPaySellWebView(
